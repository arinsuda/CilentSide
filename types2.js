...
console.log(_b1c)
let x = 1
console.log(typeof x)//weakly and dynamic data types
console.log(x)
x = 'A'
console.log(x)
...
nums.id = 555
console.log(nums)
console.log(obj)//ids is an array type
...
if (q === null)
    console.log('q is null')// == check only value, do not care data type
if ('2' == 2) console.log(`'2' == 2`)//=== check data type first, if the data type does not match then return false otherwise value will be check.
if ('2' === 2) console.log(`'2===2'`)
else console.log(`'2' !== 2`)
if (typeof m === 'undefined')
    console.log(`typeof m ==='undefined'`)//null has typeof object
if (typeof q === 'object') console.log(`typeof n === 'object'`)
function doSomething(activity) { return activity }
